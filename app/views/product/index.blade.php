    ...
    <div class="container-fluid px-4 py-4">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="/product/create" class="btn btn-brand btn-sm shadow-sm"><i class="bi bi-plus-lg me-1"></i> Thêm mới</a>
            </div>
            <?php if (isset($mess)): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($p['sale_price'] > 0): ?>
                                        <small class="text-decoration-line-through text-muted"><?= number_format($p['sale_price'], 0, ',', '.') ?> đ</small>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td class="text-center pe-4">
                                    <a href="/product/edit/<?= $p['id'] ?>" class="btn btn-sm btn-light border text-primary" title="Sửa"><i class="bi bi-pencil"></i></a>
                                    <a href="/product/delete/<?= $p['id'] ?>" class="btn btn-sm btn-light border text-danger ms-1" onclick="return confirm('Xóa sản phẩm này?');" title="Xóa"><i class="bi bi-trash"></i></a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        <?php endif; ?>
