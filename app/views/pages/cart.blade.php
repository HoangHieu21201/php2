        ...
        <div class="row g-4">
                                ...
                                @foreach ($cartItems as $item)
                                    ...
                                    <tr>
                                                    ...
                                                    <div class="small text-muted">
                                                        @if(!empty($item['attributes']))
                                                            @foreach($item['attributes'] as $attr)
                                                                <span class="badge bg-light text-secondary border fw-normal me-1">{{ $attr }}</span>
                                                            @endforeach
                                                        @else
                                                            <span>Mặc định</span>
                                                        @endif
                                        ...
                                        <td class="text-center">
                                            <span class="fw-semibold">{{ number_format($item['final_price'], 0, ',', '.') }}đ</span>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm p-4 sticky-top" style="top: 20px;">
                    ...
                    <a href="/checkout" class="btn btn-brand w-100 py-2 fw-bold text-uppercase mb-2">Tiến hành thanh toán</a>
                    <a href="/userproductdetail" class="btn btn-outline-secondary w-100 py-2"><i class="bi bi-arrow-left me-1"></i> Tiếp tục mua hàng</a>
                </div>
            </div>
        </div>
    @endif
